$(function(){
  ...
  $("#gmap_list li").each(function(){
    ...
    var _level = $(this).find(".gmap_level") ? $(this).find(".gmap_level").text() : "";
    var _info_temp = $(this).find(".gmap_info").html().split("<br>");
    var _distance = _info_temp[0] ? _info_temp[0].split("</strong>")[1] : "";
    var _level2 = _info_temp[1] ? _info_temp[1].split("</strong>")[1] : "";
    var _depth = (_info_temp[2] && _info_temp[2].split("</strong>")[1]) ?  _info_temp[2].split("</strong>")[1].split("\n").join("").split("\t").join("") : "";
    var _flow = _info_temp[3] ? _info_temp[3].split("</strong>")[1] : "";
    var _desc_temp =  $(this).find(".gmap_description").text().split("■");
    var _description = _desc_temp[1] ? _desc_temp[1].split("：")[1] : "";
    var _fish = _desc_temp[2] ? _desc_temp[2].split("：")[1] : "";
